...
export function makeWarlockBuilderState(overrides: Partial<BuilderState> = {}): BuilderState {
  return makeBuilderState({
    ...
    equipment: [
      ...
      { name: "Leather Armor", equipped: true, quantity: 1, type: "Armor", armorClass: 11 },
      { name: "Component Pouch", equipped: true, quantity: 1, type: "Gear" },
    ],
...
export function makeMulticlassBuilderState(overrides: Partial<BuilderState> = {}): BuilderState {
  return makeBuilderState({
    ...
    equipment: [
      ...
      { name: "Chain Shirt", equipped: true, quantity: 1, type: "Armor", armorClass: 13 },
    ],
